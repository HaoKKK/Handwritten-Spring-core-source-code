...
# 项目内容
本项目主要包括Spring核心的IOC和AOP，基本的MVC，不包括视图解析，ORM层目前也没有，因为Spring自带的ORM已经很少使用，主要还是Mybatis。Spring的事务管理也将会在后续有时间的情况下加以补充。
...
# 测试
本项目测试都在java包下的test里，注意是main下的java包下的test！！！，读者想测试可以写在除mySpringMVC的任何包下，只要配置好正确的扫描路径即可完成测试
# 致谢和参考
Spring源码
